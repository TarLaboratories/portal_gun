...
public class WeightedCubeRenderer extends EntityRenderer<WeightedCube> {
    ...
    public static final BlockState NOT_POWERED_STATE = portalgun.WEIGHTED_STORAGE_CUBE_BLOCK.get().defaultBlockState().setValue(WeightedStorageCubeBlock.VARIANT, 0);
    public static final BlockState POWERED_STATE = portalgun.WEIGHTED_STORAGE_CUBE_BLOCK.get().defaultBlockState().setValue(WeightedStorageCubeBlock.POWERED, true).setValue(WeightedStorageCubeBlock.VARIANT, 0);
